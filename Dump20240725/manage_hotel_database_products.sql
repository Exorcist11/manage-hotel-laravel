...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`),
  KEY `products_room_id_foreign` (`room_id`),
  CONSTRAINT `products_room_id_foreign` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2024-07-25 15:16:06
