...
CREATE TABLE `bills` (
  ...
  PRIMARY KEY (`id`),
  KEY `bills_room_id_foreign` (`room_id`),
  CONSTRAINT `bills_room_id_foreign` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2024-07-25 15:16:04
